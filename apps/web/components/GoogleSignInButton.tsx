  ...
  return (
    <div className="flex flex-col gap-3">
      <button
        ...
        onClick={handleClick}
        disabled={loading}
        className="flex items-center justify-center gap-2.5 rounded-full border border-brand-border bg-white px-4 py-2.5 text-sm font-semibold text-gray-700 transition-colors hover:bg-brand-surface disabled:opacity-60"
      >
        <GoogleLogo />
